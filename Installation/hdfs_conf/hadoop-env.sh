...
export HADOOP_HOME=${HADOOP_HOME:-/usr/hdp/2.5.3.0-37/hadoop}
...
export HADOOP_LIBEXEC_DIR=/usr/hdp/2.5.3.0-37/hadoop/libexec

# Mostly required for hadoop 2.0
export JAVA_LIBRARY_PATH=${JAVA_LIBRARY_PATH}:/usr/hdp/2.5.3.0-37/hadoop/lib/native/Linux-amd64-64
